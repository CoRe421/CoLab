...
namespace CollabGameplayTags
{
	...
	COLLAB_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Game);
	COLLAB_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_GameMode);
	COLLAB_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Menu);
	COLLAB_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Layer_Settings);
}
