...
ACoLabCharacter::ACoLabCharacter(const FObjectInitializer& ObjectInitializer)
...
void ACoLabCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//
	// 	// Moving
	// 	EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACoLabCharacter::Move);
	//
	// 	// Looking
...
// void ACoLabCharacter::Move(const FInputActionValue& Value)
// {
// 	// input is a Vector2D
...
// }
//
// void ACoLabCharacter::Look(const FInputActionValue& Value)
// {
// 	// input is a Vector2D
